...
?>
    ...
    <!-- Header -->
    <?php include "./views/assets/inc/navbar.php" ?>
    <!-- Close Header -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-danger border-bottom pb-3 border-light logo">AmericanSHOP</h2>
                    <ul class="list-unstyled text-light footer-link-list">
                        <li>
                            <i class="fas fa-map-marker-alt fa-fw"></i>
                            Cra 46 - 13 Barrio Bellavista
                        </li>
                        <li>
                            <i class="fa fa-phone fa-fw"></i>
                            <a class="text-decoration-none" href="tel:318-461-2011">318-461-2011</a>
                        </li>
                        <li>
                            <i class="fa fa-envelope fa-fw"></i>
                            <a class="text-decoration-none" href="mailto:americanshopbtura@gmail.com">americanshopbtura@gmail.com</a>
                        </li>
                    </ul>
                </div>

                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-light border-bottom pb-3 border-light">Articulos</h2>
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none" href="#">Tennis</a></li>
                        <li><a class="text-decoration-none" href="#">Camisetas</a></li>
                        <li><a class="text-decoration-none" href="#">Chanclas</a></li>
                        ...
                        <li><a class="text-decoration-none" href="#">Pantaloneta</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li><a class="text-decoration-none" href="#">Donde Estamos?</a></li>
                    </ul>
                </div>
